...
export default function NewsDetailPage() {
  ...
  // For now, we'll simulate it or just show a generic "Not Found" if strictly needed,
  // but better to show a "Mock" article for demonstration.
            ...
            <div className="lg:col-span-8">
              ...
              >
                <p className="font-medium text-white text-xl">
                  Surabaya — GenBI Jawa Timur kembali menunjukkan komitmennya
                  dalam mendukung kebijakan Bank Indonesia. Kali ini, ratusan
                  anggota GenBI diterjunkan langsung ke pasar-pasar tradisional
                  untuk mensosialisasikan penggunaan QRIS.
                </p>
                <p>
                  Kegiatan ini merupakan bagian dari "Pekan QRIS Nasional" yang
                  diselenggarakan serentak. Tidak hanya sekadar membagikan
                  brosur, teman-teman GenBI juga mendampingi para pedagang untuk
                  mendaftar dan mempraktikkan langsung cara bertransaksi
                  menggunakan QRIS.
                </p>
                <p>
                  "Tantangan terbesar adalah mindset," ujar salah satu
                  koordinator lapangan. "Banyak pedagang sepuh yang takut
                  teknologi. Tapi dengan pendekatan personal, mereka jadi paham
                  bahwa QRIS itu justru memudahkan, mencatat transaksi otomatis,
                  dan bebas uang kembalian receh."
                </p>
                ...
                <p>
                  Data menunjukkan peningkatan transaksi non-tunai sebesar 40%
                  di pasar target setelah kegiatan ini. Hal ini membuktikan
                  bahwa edukasi *face-to-face* oleh generasi muda sangat efektif
                  dalam mengakselerasi digitalisasi ekonomi daerah.
                </p>
              </SlideUp>
