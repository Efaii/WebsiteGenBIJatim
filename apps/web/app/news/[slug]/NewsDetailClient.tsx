 ...
 * @description Interactive client component for rendering individual news article detail pages.
 */
export default function NewsDetailClient() {
  ...
  > = {
    "genbi-jatim-leadership-camp": {
      ...
      heroImage: "/assets/images/galeri/1.jpg",
      content: (
        <>
          <p className="font-medium text-white text-xl">
            ...
            pembukaan &quot;GenBI Jatim Leadership Camp 2024&quot; yang digelar
          ...
          <p>
            ...
            *agent of change* bagi lingkungan sekitarnya. &quot;Kalian adalah
            energi baru yang akan menggerakkan literasi ekonomi hingga ke
            pelosok desa,&quot; tegasnya.
          </p>

          <div className="my-8 rounded-[2rem] overflow-hidden relative h-[400px]">
            <Image
          ...
          <p>
            ...
            dari *Central Banking*, *Leadership &amp; Team Building*, hingga
            *Public Speaking* yang dibawakan oleh praktisi ternama. Tak hanya
            duduk di ruangan, peserta juga diajak untuk melakukan simulasi
            sidang pemecahan masalah ekonomi regional.
          </p>
          ...
          <p>
            ...
            menyelimuti ballroom ketika seluruh peserta menyanyikan lagu
            &quot;Padamu Negeri&quot; sambil memegang lilin, simbol komitmen
            untuk terus menerangi negeri dengan prestasi.
          </p>
          <p>
            &quot;Leadership Camp ini benar-benar membuka mata saya. Saya jadi
            paham betapa besarnya tanggung jawab kami sebagai *frontliner* Bank
            Indonesia,&quot; ujar Raka, salah satu peserta dari Universitas
            Jember.
          </p>
        </>
      ),
  ...
  const data = newsData[slugStr] || {
    ...
    content: (
      <>
        ...
        <p>
          Kegiatan ini merupakan bagian dari &quot;Pekan QRIS Nasional&quot;
          yang diselenggarakan serentak. Tidak hanya sekadar membagikan brosur,
        ...
        <p>
          &quot;Tantangan terbesar adalah mindset,&quot; ujar salah satu
          koordinator lapangan. &quot;Banyak pedagang sepuh yang takut
          teknologi. Tapi dengan pendekatan personal, mereka jadi paham bahwa
          QRIS itu justru memudahkan, mencatat transaksi otomatis, dan bebas
          ...
          <div className="container mx-auto px-6 relative z-10 pb-12">
            <div className="max-w-4xl">
              <FadeIn>
                ...
                <h1 className="h1 text-white mb-6 capitalize">{data.title}</h1>
        ...
        <section className="container mx-auto px-6 relative z-10 -mt-8">
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-12">
            <div className="lg:col-span-8">
              <SlideUp
                delay={0.2}
                className="bg-white/5 backdrop-blur-md border border-white/10 rounded-[2rem] p-8 md:p-12 space-y-6 text-blue-100/80 text-lg leading-relaxed"
              >
                {data.content}
              </SlideUp>
