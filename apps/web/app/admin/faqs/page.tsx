  ...
  return (
    <div className="space-y-6 animate-in fade-in duration-500">
      <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4">
        <div>
          <h1 className="text-2xl font-extrabold text-[#0e2f5a]">Kelola FAQ</h1>
          <p className="text-slate-500 text-sm mt-1">
            Daftar Pertanyaan yang Sering Diajukan di beranda.
          </p>
        </div>
        <button
              ...
              {isLoading ? (
                ...
                faqs.map((faq) => (
                  ...
                  >
                    ...
                    <td className="px-6 py-4 font-semibold text-[#0e2f5a]">
                      {faq.question}
                    </td>
                    ...
                    <td className="px-6 py-4 text-center">
                      <span
                        className={`inline-flex px-2.5 py-1 rounded-full text-xs font-bold ${faq.isActive ? "bg-emerald-100 text-emerald-700" : "bg-slate-100 text-slate-500"}`}
                      >
            ...
            <form onSubmit={handleSubmit} className="p-6 space-y-5">
              <div>
                ...
                <input
                  ...
                  placeholder="Contoh: Kapan pendaftaran beasiswa ditutup?"
                />
              </div>
              ...
              <div>
                ...
                <textarea
                  ...
                  className="w-full px-4 py-3 border border-slate-300 text-slate-900 rounded-xl focus:ring-2 focus:ring-blue-500 focus:border-blue-500 outline-none transition-all resize-none"
                  placeholder="Ketik jawaban selengkapnya di sini..."
                />
              </div>
