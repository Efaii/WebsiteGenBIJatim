...
function ValueItem({
  ...
  return (
    <motion.div 
      ...
      className="flex flex-col h-full gap-6 p-8 rounded-[2rem] bg-slate-50 border border-slate-200/60 shadow-xl shadow-slate-200/50 hover:bg-white hover:border-blue-200 hover:shadow-2xl hover:shadow-blue-900/10 transition-[background-color,border-color,box-shadow] duration-700 ease-[cubic-bezier(0.33,1,0.68,1)] group transform-gpu will-change-[transform,background-color,border-color]"
    >
      {/* ICON_WRAPPER_UI */}
      <div className="w-14 h-14 rounded-full flex items-center justify-center text-blue-600 bg-white shadow-inner border border-blue-100/50 group-hover:bg-blue-600 group-hover:text-white transition-colors duration-700 ease-[cubic-bezier(0.33,1,0.68,1)] shrink-0 transform-gpu">
        <Icon className="w-6 h-6" strokeWidth={1.5} />
      </div>

      {/* TEXT_CONTENT_UI */}
      <div className="flex flex-col flex-1">
        <h3 className="h4 mb-2 group-hover:text-blue-600 transition-colors duration-500 ease-[cubic-bezier(0.33,1,0.68,1)]">
          {title}
        </h3>
